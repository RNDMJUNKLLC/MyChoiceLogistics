      ...
      <div className="max-w-5xl mx-auto px-4 text-center">
        <div className="flex items-center justify-center gap-4">
          ...
          <div className="text-left">
            <h1 className="text-3xl md:text-4xl font-bold">24/7 Medical Courier & Specimen Transport</h1>
            <p className="mt-1">Same-day lab pickups, refrigerated cold-chain delivery, and emergency medical courier service across VA · MD · PA · NJ.</p>
          </div>
        </div>
